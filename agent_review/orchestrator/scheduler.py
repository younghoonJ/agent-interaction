...
from agent_review.messaging.schemas import AGENT_CLAUDE, AGENT_CODEX, ReviewReport
...
class Scheduler:
    ...
    def evaluate_completed(
        ...
        if report.requires_human_review or report.has_critical_finding():
            return ScheduleDecision(STATE_AWAITING_HUMAN, None, None, "human review required", no_finding_rounds)
